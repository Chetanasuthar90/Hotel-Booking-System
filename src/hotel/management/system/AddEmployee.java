...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee () {
        ...
        ButtonGroup bg = new ButtonGroup(); //through this we can group two buttons so that we can select only one option
        bg.add(rbmale);
        bg.add(rbfemale);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String job = (String) cbjob.getSelectedItem(); //which item is selected
