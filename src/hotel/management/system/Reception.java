...
public class Reception extends JFrame implements ActionListener{
    ...
    Reception() {
        ...
        checkout = new JButton("Checkout");//if customer want to leave hotel
        ...
        searchRoom = new JButton("Search Room"); //if i want to search room
        ...
        logout = new JButton("Logout"); //if i want to search room
