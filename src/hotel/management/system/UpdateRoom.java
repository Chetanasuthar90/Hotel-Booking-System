...
public class UpdateRoom extends JFrame implements ActionListener{  // in class we will check that there is any pending amount
    ...
    UpdateRoom() {
        ...
        tfavailable.setBounds(200, 180, 150, 24);
        add(tfavailable);
        ...
        tfstatus.setBounds(200, 230, 150, 24);
        add(tfstatus);
